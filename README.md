...
*	Classes with properties, events, operator overloading and introspection.
...
*	When you want to allow the end users of your application to affect its behaviour by providing custom scripts; those may be admin scripts or business logic scripts.
...
*	Support for indexers in custom classes (still trying a suitable syntax).
*	An update for the Mono platform (release 0.9.5 ships no particular update for Mono/Linux).
