...
In addition to the predefined functions, users can define their own functions in AddyScript and use them.
...
Once the parser encounters a named argument, it expects all following arguments to be named as well.
