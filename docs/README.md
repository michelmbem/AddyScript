...
AddyScript has a simple syntax, similar to that of C (or JavaScript or PHP, depending on your preference),
with dynamic typing and consistent object-oriented programming features.
