...
namespace AddyScript.Gui
{
    public partial class EditorForm : Form
    {
        ...
        private void InitializeAutocomplete()
        {
            ...
            // Keywords menu
            string keywords = @"
                abs?3 abstract?0 acos?3 as?0 asin?3 atan?3 atan2?3 bool?1 break?0 case?0 catch?0 ceil?3 chr?3 class?0
                closure?1 complex?1 const?0 constructor?0 contains?4 continue?0 cos?3 cosh?3 date?1 decimal?1 default?0
                ...
                new?4 NEWLINE?2 NINFINITY?2 now?3 null?2 object?1 operator?0 ord?3 pack?3 params?0 PI?2 PINFINITY?2 print?3
