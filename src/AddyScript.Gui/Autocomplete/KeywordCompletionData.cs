...
internal partial class KeywordCompletionData(string keyword, KeywordType type) : ICompletionData
{
    ...
    static KeywordCompletionData()
    {
        const string keywords =
            ...
            NAN?2 new?4 NEWLINE?2 NINFINITY?2 not?4 now?3 null?2 object?1 operator?0 or?4 ord?3 pack?3 PI?2 PINFINITY?2
            ...
            super?5 switch?0 tan?3 tanh?3 this?5 throw?0 true?2 trunc?3 try?0 tuple?1 typeof?4 unpack?3 var?0 void?1 when?4
