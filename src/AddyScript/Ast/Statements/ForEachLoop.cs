...
/// <param name="guard">The collection on which enumeration is done</param>
/// <param name="action">The body of the loop</param>
public class ForEachLoop(string keyName, string valueName, Expression guard, Statement action)
