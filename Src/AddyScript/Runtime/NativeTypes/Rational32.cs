...
namespace AddyScript.Runtime.NativeTypes
{
    ...
    public struct Rational32
        : IFormattable, IConvertible, IComparable,
          IComparable<Rational32>, IEquatable<Rational32>
    {
        #region Fields

        public static readonly Rational32 MinusOne = new Rational32(-1);
        public static readonly Rational32 Zero = new Rational32(0);
        public static readonly Rational32 One = new Rational32(1);
        public static readonly Rational32 Half = new Rational32(1, 2);
        public static readonly Rational32 Quarter = new Rational32(1, 4);
        ...
        public int Sign
        {
            get { return Math.Sign(numerator); }
        }
        ...
        {
            return obj is Rational32 && this == (Rational32) obj;
        }
        ...
        {
            Rational32 c, d;
            ToCommonDenominator(a, b, out c, out d);
        ...
        public static Rational32 operator *(Rational32 a, Rational32 b)
        {
            return new Rational32(a.numerator * b.numerator,
                                  a.denominator * b.denominator);
        }

        public static Rational32 operator /(Rational32 a, Rational32 b)
        {
            return new Rational32(a.numerator * b.denominator,
