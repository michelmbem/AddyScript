...
namespace AddyScript.Runtime
{
    ...
    /// </summary>
    public class ClassEvent : ClassMember
    {
        /// <summary>
        ...
        public ClassEvent(string name, Scope scope, Modifier modifier, Parameter[] parameters)
        ...
        /// <summary>
        /// Gets the name of the field that would automatically be generated
        /// to hold the collection of the handlers of this event.
        /// </summary>
        ...
        /// <summary>
        /// Gets the name of the method that would automatically be generated
        ...
        {
            var addHandlerFunc = new Function(new[] {new Parameter("handler")},
