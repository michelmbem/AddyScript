...
namespace AddyScript.Runtime.Utilities
{
    public static class MathUtil
    {
        ...
        {
            if (a < 0) throw new ArgumentOutOfRangeException("a", "Cannot compute the Gcd of negative numbers");
            if (b < 0) throw new ArgumentOutOfRangeException("b", "Cannot compute the Gcd of negative numbers");
