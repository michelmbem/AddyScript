...
namespace AddyScript.Runtime
{
    ...
    public static class RuntimeServices
    {
        ...
        public static bool Equals(Dynamic a, Dynamic b)
        {
        ...
        public static int HashCode(Dynamic value)
        {
        ...
        /// <param name="b">The given argument</param>
        /// <returns>An <see cref="int"/></returns>
        public static int CompareTo(Dynamic a, Dynamic b)
        {
        ...
        public static string ToString(Dynamic value, string format)
        {
        ...
        public static Dynamic Clone(Dynamic value)
        {
        ...
        public static void Dispose(Dynamic value)
        {
