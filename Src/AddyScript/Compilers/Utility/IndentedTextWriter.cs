...
namespace AddyScript.Compilers.Utility
{
    public class IndentedTextWriter : TextWriter
    {
        ...
        private readonly Stack<string> prefixStack = new Stack<string>();
        private readonly StringBuilder prefixBuilder = new StringBuilder();
        ...
        public override void Write(char value)
        {
            ...
            if (lineStart)
                prefixBuilder.Remove(0, prefixBuilder.Length);
            else
